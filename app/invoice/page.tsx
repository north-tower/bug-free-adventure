...
function Invoice(){
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        ...
        <div class="flex w-full flex-col px-4 py-4">
          ...
          <p class="text-lg font-bold">KES138.99</p>
        </div>
      </div>
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        ...
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">Nike Air Max Pro 8888 - Super Light</span>
          <span class="float-right text-gray-400">42EU - 8.5US</span>
          <p class="mt-auto text-lg font-bold">KES238.99</p>
        </div>
      </div>
    </div>
  ...
  <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <p class="text-gray-400">Complete your invoice by providing the customer details.</p>
    <div class="">
      ...
      <label for="card-holder" class="mt-4 mb-2 block text-sm font-medium">Customer Address</label>
      <div class="relative">
        <input type="text" id="card-holder" name="card-holder" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Enter Address here" />
        
      </div>
      <label for="card-holder" class="mt-4 mb-2 block text-sm font-medium">Billing Preferences</label>
      <div class="relative">
        <input type="text" id="card-holder" name="card-holder" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Bill preferences" />
        
      </div>
  
    </div>
    <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Create Invoice</button>
  </div>
</div>
  </>
  )
