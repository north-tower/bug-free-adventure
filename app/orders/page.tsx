...
function Orders() {
  ...
  <h1 className="mt-10  ml-5 text-2xl font-bold text-gray-900">Expense Management</h1>
  <div className="bg-white py-2 px-3">
    <nav className="flex flex-wrap gap-4">
     <Link href="/expenses"> Add Expense </Link>

      <a href="#" className="inline-flex whitespace-nowrap border-b-2 border-transparent py-2 px-3 text-sm font-medium text-gray-600 transition-all duration-200 ease-in-out hover:border-b-purple-600 hover:text-purple-600"> Add Expense Category  </a>

      <a href="#" className="inline-flex whitespace-nowrap border-b-2 border-transparent border-b-purple-600 py-2 px-3 text-sm font-semibold text-purple-600 transition-all duration-200 ease-in-out"> Orders </a>

      <a href="#" className="inline-flex whitespace-nowrap border-b-2 border-transparent py-2 px-3 text-sm font-medium text-gray-600 transition-all duration-200 ease-in-out hover:border-b-purple-600 hover:text-purple-600"> Sales </a>
  ...
  <div className="mx-auto  px-2 py-10">
    ...
    <div className="mt-6 overflow-hidden rounded-xl bg-white px-6 shadow lg:px-4">
      <table className="mx-auto border-collapse border-spacing-y-2 border-spacing-x-2">
